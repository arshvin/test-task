...
public class EntryPoint {
  ...
  public SimpleEntity getNowDate() {
    ...
    return new SimpleEntity(
        EntityType.DATE_NOW, LocalDate.now().format(DateTimeFormatter.ofPattern("yyyy MM dd")));
  }
  ...
  public SimpleEntity getNowTime() {
    ...
    return new SimpleEntity(
        EntityType.TIME_NOW, LocalDateTime.now().format(DateTimeFormatter.ofPattern("hh:mm:ss")));
  }
